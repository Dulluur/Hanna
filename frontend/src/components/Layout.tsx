  ...
  return (
    <div className="min-h-svh bg-background flex flex-col">
      <header className="sticky top-0 z-10 border-b bg-background/95 backdrop-blur">
        <div className="container flex h-14 items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <Logo className="h-8 w-8 ring-0" letterClassName="text-sm" />
            <h1 className="text-lg font-semibold tracking-tight">
              <a href="/">Hanna · Якутск</a>
            </h1>
          </div>
                ...
                className={({ isActive }) =>
                  cn(
                    ...
                    isActive
                      ...
                      : "text-muted-foreground hover:bg-accent hove: text-foreground",
                  )
                }
              >
      ...
      <nav className='fixed bottom-0 inset-x-0 z-20 border-t bg-background md:hidden'>
        <ul className="container grid grid-cols-5 h-16 items-end">
